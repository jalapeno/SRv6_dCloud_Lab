...
# sed -i 's/linux:xr-130/linux:eth1/g' docker-compose-lab_3.yml
# sed -i 's/xrd01-gi3: null/macvlan3: null/g' docker-compose-lab_3.yml
...
# sed -i 's/linux:xr-190/linux:eth1/g' docker-compose-lab_3.yml
# sed -i 's/xrd07-gi3: null/macvlan2: null/g' docker-compose-lab_3.yml
