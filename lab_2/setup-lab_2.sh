...
### Uncomment these lines if you need to rebuild lab_2's docker-compose-lab_2.yml file:
...
# sed -i 's/linux:xr-130/linux:eth1/g' docker-compose-lab_2.yml
# sed -i 's/xrd01-gi3: null/macvlan3: null/g' docker-compose-lab_2.yml
...
# sed -i 's/linux:xr-190/linux:eth1/g' docker-compose-lab_2.yml
# sed -i 's/xrd07-gi3: null/macvlan2: null/g' docker-compose-lab_2.yml
