...
def main():
    ...
    parser.add_argument("-e", help="encapsulation type <sr> <srv6>", type=str.lower)
    parser.add_argument("-f", help="json file with src, dst, parameters", type=str.lower)  
    parser.add_argument("-s", help="requested network service: ll = low_latency, lu = least_utilized, ds = data_sovereignty, gp = get_paths)", type=str.lower)
