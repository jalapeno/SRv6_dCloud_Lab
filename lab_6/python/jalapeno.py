...
def main():
    ...
    parser.add_argument('-e', '--encap',required = True, help='encapsulation type <sr> <srv6>')
    parser.add_argument('-f', '--file',required = True, help='json file with src, dst, parameters')  
    parser.add_argument('-s', '--service',required = True, help='requested network service: ll = low_latency, lu = least_utilized, ds = data_sovereignty, gp = get_paths)')
